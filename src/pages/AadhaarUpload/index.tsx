  ...
  return (
    <div className="flex px-16 pt-20 gap-10">
      ...
      <div className='w-1/2'>
        ...
        <h2 className="mx-auto">{t('Place your aadhaar card inside the red frame.')}</h2>
        {ocrError && <h2 className="mx-auto">{t('Aadhaar card was not detected, please retake the photo.')}</h2>}
