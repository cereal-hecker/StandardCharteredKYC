    ...
    <h1 className="text-4xl font-bold mb-4">Aadhaar Card Upload</h1>
      ...
      <div className="flex flex-col gap-2 mt-20">
          {capturedImage ? (
            ...
            <button onClick={handleCapture} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Capture Frame</button>
          )}
        </div>
      </div>
      </div>
