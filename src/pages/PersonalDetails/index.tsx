...
export default function PersonalDetails() {
  ...
  return (
    <div className="flex px-16 pt-20 gap-10">
      ...
      <div className="w-1/2">
        <h1 className="text-4xl font-bold mb-8">{t("Personal Details")}</h1>
        <div className="grid grid-cols-2 gap-4">
            ...
            <div className="w-[300px] mb-2">
              {capturedImage ? (
                <img
                  src={capturedImage}
                  alt="Captured frame"
                  className="border-3 border-gray-300 rounded-md"
                />
              ) : (
          ...
          <div className="justify-center flex flex-col space-between">
            <h2 className="mb-6">{t('Ensure your face is centered and well-lit within the red frame.')}</h2>
            {capturedImage ? (
              <>
                <button
